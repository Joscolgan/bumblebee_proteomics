...
combined_boxplot <- annotate_figure(combined_boxplot,
                left = text_grob("LFQ values",
                                 color = "black",
                                 rot = 90,
                                 face = "bold",
                                 size = 15),
                bottom = text_grob("Life stages",
                                   color = "black",
                                   face = "bold",
                                   size = 15)
)
...
## Define output:
output <- "results/olfaction_lfq_box_plots.png"
...
## Save plot:
save(combined_boxplot, file = "results/olfaction_lfq_box_plot.Rdata")
```
...
```{r, message = FALSE}
## Run lintr:
lintr::lint(file = "./Bombus_queen_haemolymph_proteome_olfaction_boxplots.Rmd")
```
