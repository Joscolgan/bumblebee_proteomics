...
proteins_of_interest$protein_id <- as.character(unlist(proteins_of_interest$protein_id))
...
ggarrange(reformat_for_plot(tmp_trans_2,
...
## Define output:
output <- "results/amp_box_LFQ_plots.png"
...
```{r, message = FALSE}
## Run lintr:
lintr::lint(file = "./Bombus_queen_haemolymph_proteome_amp_lfq_boxplots.Rmd")
```
