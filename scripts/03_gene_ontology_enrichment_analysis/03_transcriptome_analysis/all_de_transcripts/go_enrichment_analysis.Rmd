...
directory <- "./"
de_genes_file <- paste(directory, "de_genes_post_vs_diapause.sig_lrt_only_input_for_go.txt", sep = "")

output_directory <- "results/output_node_20_weight_ks_adjusted"
...
## Read in input file:
de_genes <- read.table(file = de_genes_file,
                       col.names = c("locus", "raw_pvalue"),
                       header = FALSE)
